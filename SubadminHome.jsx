import SubadminCard from "./src/Components/Shared/CardGobal";
import SubadminChart from "./src/Components/Shared/GlobalChart";
...
const SubadminHome = () => {
    return (
        <div className="px-5 max-w-screen-xl mx-auto">
            ...
            <SubadminCard />
            <div className="hidden md:flex gap-4 mt-5 mb-10">
                <SubadminChart />
                <SubadminPiechart />
            </div>
        </div>
