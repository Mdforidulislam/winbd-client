...
const AdminCustomerCare = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://winbd-server-test-2.vercel.app/getSocialMFPF?authorId=${authurId}`);
    ...
    const handleUpdateCustomerCareNumber = async (platform, link) => {
        try {
            ...
            await axios.put(`https://winbd-server-test-2.vercel.app/insertSocialMFPF?authorId=${localData}`, updatedData);
