...
const Promotion = () => {
    ...
    useEffect(() => {
        ...
        const fetchCampaigns = async () => {
            try {
                const response = await axios.get('https://winbd-server-test-2.vercel.app/getingPromotininfo');
    ...
    const handleSave = async () => {
        try {
            const response = await axios.post('https://winbd-server-test-2.vercel.app/promtionOfferinser', formData);
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await axios.put(`https://winbd-server-test-2.vercel.app/updatePromotionData?id=${currentId}`, formData);
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await axios.delete(`https://winbd-server-test-2.vercel.app/deletedPromtion?id=${currentId}`);
