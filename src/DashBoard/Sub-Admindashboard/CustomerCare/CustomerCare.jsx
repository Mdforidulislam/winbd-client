...
const AdminCustomerCare = () => {
        ...
        const fetchData = async () => {
            try {
                const [socialResponse, emailResponse] = await Promise.all([
                    axios.get(`https://windb-server-live.onrender.com/getSocialMFPF`, { params: { authorId: authId } }),
                    axios.get(`https://windb-server-live.onrender.com/getingSubAdminEmail`, { params: { authoreId: authId } })
                ]);
    ...
    const handleUpdateCustomerCareNumber = async (platform, link) => {
        try {
            ...
            const response = await axios.put(`https://windb-server-live.onrender.com/insertSocialMFPF`, updatedData, { params: { authorId } });
    ...
    const handleUpdateCustomerCareEmail = async (link) => {
        try {
            ...
            const response = await axios.put(`https://windb-server-live.onrender.com/updateSubAdminEmail`, updatedData, { params: { authoreId: authorId } });
