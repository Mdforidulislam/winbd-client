...
const AgentNumber = ({ paymentType, activeTab }) => {
    ...
    useEffect(() => {
        const fetchAgentData = async () => {
            ...
            try {
                const { data: serverData } = await axios.get(`https://windb-server-live-test.vercel.app/getingPaymentmethod?uniqueId=${state.localData}&paymentType=${paymentType}`);
    ...
    const handleUpdatePayment = async (e) => {
        ...
        try {
            const { data: response } = await axios.patch('https://windb-server-live-test.vercel.app/updatePaymentMethod', formValues);
